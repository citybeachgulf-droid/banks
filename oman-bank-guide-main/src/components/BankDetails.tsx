    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between gap-3 flex-col sm:flex-row">
        ...
        <div className="flex items-center gap-2 w-full sm:w-auto">
          <Button onClick={exportAllData} className="gap-2 bg-gradient-accent w-full sm:w-auto">
                ...
                <CardHeader>
                  <div className="flex justify-between items-start gap-3 flex-col sm:flex-row">
                    ...
                    <div className="flex items-center gap-2 w-full sm:w-auto flex-wrap">
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button variant="destructive" size="sm" className="h-8 px-2 w-full sm:w-auto">
                            <Trash2 className="w-4 h-4" />
                          </Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center gap-3 flex-col sm:flex-row">
                ...
                <div className="flex gap-2 w-full sm:w-auto">
                  <Button variant="outline" className="w-full sm:w-auto" onClick={() => setSelectedBranch(null)}>
                    عرض جميع الفروع
                  </Button>
